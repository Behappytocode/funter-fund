...
import { History, BookOpen, ExternalLink, ShieldCheck, Database } from 'lucide-react';
            ...
            <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-mono">id, name, email, role, joinedAt</p>
                </div>
              </div>
            </div>
          </div>
